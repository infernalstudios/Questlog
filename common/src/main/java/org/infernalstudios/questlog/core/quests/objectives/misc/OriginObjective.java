...
/**
 * Objective that completes when the player has a specific origin (from the Origins mod)
 * assigned.
 */
public class OriginObjective extends Objective {
    ...
    public OriginObjective(JsonObject definition) {
        super(definition);
        this.origin = ResourceLocation.parse(JsonUtils.getString(definition, "origin"));
    }
