...
Questlog is a NeoForge mod. To modify any dependency versions or mappings, refer to build.properties, don't change them in build.gradle.
...
The superclass must listen to events on the neoforge event bus to update its state, when it does,
