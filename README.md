...
Well! Unlike FTB Quests, which presents its quests in sprawling spreadsheets,_this_ mods quests are presented in a
...
The mod was conceptualised and is designed around the principle of**conveyance.** Creators can write quests so that when
they trigger (or are completed!), they display either their own toast panels,**or** they outright_pop-up_ in your face
directly, so you can never miss an important piece of info.
...
Check out the wiki for info on how to use
Questlog: [https://github.com/infernalstudios/Questlog/wiki](https://github.com/infernalstudios/Questlog/wiki)
...
B.8.0**[here](https://www.curseneoforge.com/minecraft/modpacks/resurvival/files/6266222)
