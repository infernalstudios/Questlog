...
//
// See <a href="./objective_types">Objective Types</a> for a list of built-in objective types.
...
// See <a href="./reward_types">Reward Types</a> for a list of built-in reward types.
<strong>type</strong>: <a href="#resourcelocation">ResourceLocation</a>,
...
// Read more in <a href="./popup">Popup</a>.
